# DaSilva2014_圆柱干燥变物性与热质耦合

来源：[DaSilva2014_圆柱干燥变物性与热质耦合.pdf](DaSilva2014_圆柱干燥变物性与热质耦合.pdf)
...
Three experiments were carried out at average drying air temperature of 47.9, 58.6 and 66.9 /C176C, enabling
...
0260-8774//C2112014 Elsevier Ltd. All rights reserved.
...
66.9 /C176C. In each experiment, the drying air temperature was mea-
sured twenty times along the process, and the correspondent stan-
dard deviations for the average values of 47.9, 58.6 and 66.9 /C176C
were 0.7, 0.8 and 0.6 /C176C, respectively. During the experiments,
...
and placed within an oven at 105 /C176C. The product remained there
Nomenclature
Aw, Ap, Ae, B coefﬁcients of the discretized diffusion equation
a, b ﬁtting parameters
As area of the surface of the cylinder (m 2)
cp speciﬁc heat of product (J kg /C0 1 K/C0 1)
cv speciﬁc heat of vapor of water (J kg /C0 1 K/C0 1)
D effective moisture diffusivity (m 2 s/C0 1)
hm convective mass transfer coefﬁcient (m s /C0 1)
hT heat transfer coefﬁcient (m s /C0 1)
hH convective heat transfer coefﬁcient hH (W m/C0 2 K/C0 1)
hfg latent heat of vaporization of water (J kg /C0 1)
k thermal conductivity (W m /C0 1 K/C0 1)
L height of cylinder (m)
M local moisture content (kg water kg/C0 1
dry matter)
M average moisture content (kg water kg/C0 1
dry matter)
...
Greek symbols
a thermal diffusivity (m 2 s/C0 1)
v2 chi-square
CU transport coefﬁcient (dimension depends on the process
under study)
...
and velocity, /C22v) and the room air (average temperature and relative
...
a digital Multimeter Cole Parmer, with temperature range of /C0 180/C176
to 370 /C176C; and accuracy of 0.1 /C176C in the temperature range of
interest.
...
of drying, the thermal diffusivity (10 /C0 7 m2 s/C0 1) is greater than the
moisture diffusivity (10 /C0 10 m2 s/C0 1) and, consequently, the Biot
...
For a cylinder of radius R and height L, in which L /C29 R, the one-
...
radial position within the cylinder (m); k and CU are the properties
...
section of the cylinder, as is shown in Fig. 2 a.
Fig. 2 b shows details of an internal control volume P and its
...
Tair (/C176C) L0 (mm) R0 (mm) M0 (db) Mf (db) Meq (db) md (kg) cv (J kg/C0 1 /C176C/C0 1)
...
Drying air Room air
T (/C176C) RH (%) /C22v (m/s) T0 (/C176C) RHroom (%)
...
(1) it should be imposed: U /C17 M, in which M is the moisture con-
tent in dry basis (kg water kg/C0 1
dry matter); k = 1 (dimensionless); CU = D,
i.e., effective moisture diffusivity (m 2 s/C0 1).
...
Eq. (1) U, k and CU are as follows: U /C17 T, i.e., temperature (K);
k ¼ qcp, where q is the density (kg m /C0 3) and cp is the speciﬁc heat
of the product (J kg /C0 1 K/C0 1); CU = k, i.e., thermal conductivity
(W m/C0 1 K/C0 1). If the thermal conductivity is divided byqcp, a thermal
property called thermal diffusivity (m 2 s/C0 1) is obtained: a = k/qcp.
...
Meq
ð9a—c Þ
in which hm is the convective mass transfer coefﬁcient (m s /C0 1) and
...
/C12
e
¼ hT ðTe /C0 TeqÞ/C0 ½hfg þ cv ðTe /C0 TeqÞ/C138 dm
dt
qcP As
ð10Þ
where hT is the heat transfer coefﬁcient (m s /C0 1); Teq is the equilib-
rium temperature (K); cv is speciﬁc heat of the vapor (J kg /C0 1 K/C0 1);
hfg is the latent heat of vaporization (J kg /C0 1); dm/dt is the water loss
rate (kg s /C0 1) and As is the area of the surface of the cylinder (m 2),
given by As =2 pRL. In this article, it was assumed that the ratios
L/L0 are given by the same expressions provided in Table 3 for the
radius. The convective heat transfer coefﬁcient hH (W m/C0 2 K/C0 1)i s
...
For the nodal points, the diffusivity CU (D or a) can be calcu-
...
should be used to determine CU (Patankar, 1980 ):
CU
e ¼ 2CU
E CU
P
...
other hand, if CU is variable, the coefﬁcients A are also calculated
...
et al. (2012b) :
hfg ¼ 2529:1Mð/C0 1:782/C2 10/C0 2 /C0 3:570/C2 10/C0 4 TÞ /C0 2:386T ð19Þ
where hfg is obtained in kJ kg /C0 1 when M is given in dry basis and T in
/C176C.
...
cp is obtained in J kg /C0 1 K/C0 1.
Speciﬁc heat for the water vapor, cv, is provided in Table 1 .O n
the other hand, with the measurements accomplished in the
experiments, it was possible to determine an expression for the
density q of the bananas (kg m /C0 3) as a function of the average
moisture content, M (db), by curve ﬁt:
q ¼ 1533e/C0 0:1704M ð21Þ
...
2.5. Optimization
In order to determine the parameters CU (D or a) and h (hm or
hT), the parameters a and b of the function CU = f(a, b, U) and h can
...
The simulations of the drying kinetics are shown in Fig. 3 a–c,
and the superposition of these simulations is shown in Fig. 3 d.
As additional information, the graphs of Fig. 3 a–c were gener-
ated by own software developed to perform the optimizations.
Table 4
Parameters of the water migration obtained by optimization.
T (/C176C) am bm (m2 min/C0 1) hm (m min/C0 1) R2 v2
47.9 0.687 15.4 /C2 10/C0 9 2.66 /C2 10/C0 5 0.99970 15.6 /C2 10/C0 3
58.6 0.785 19.4 /C2 10/C0 9 2.68 /C2 10/C0 5 0.99989 3.87 /C2 10/C0 3
66.9 0.821 28.9 /C2 10/C0 9 2.99 /C2 10/C0 5 0.99964 9.20 /C2 10/C0 3
...
Note that the graphs of Fig. 6 a–c were also generated by soft-
...
Fig. 3. Simulation of water migration at drying air temperature of: (a) 47.9 /C176C; (b)
58.6 /C176C; (c) 66.9 /C176C; (d) superposition of the simulated curves.
Fig. 4. Effective moisture diffusivity as a function of the local moisture content at
temperature of: (a) 47.9 /C176C; (b) 58.6 /C176C; (c) 66.9 /C176C.
...
T (/C176C) aT bT (m2 min/C0 1) hT (m min/C0 1) R2 v2
47.9 0.313 1.26 /C2 10/C0 7 5.61 /C2 10/C0 4 0.99071 14.3
58.6 0.398 1.06 /C2 10/C0 7 5.71 /C2 10/C0 4 0.98843 28.9
66.9 0.520 1.26 /C2 10/C0 7 9.49 /C2 10/C0 4 0.98084 33.4
70 W.P. da Silva et al. / Journal of Food Engineering 141 (2014) 65–73

## PDF 第 7 页

performed at 58.6 /C176C, considering the parameters given in Table 5,
but supposing cv = 0. In this case, the statistical indicators of the
simulation were v2 = 29.2 (instead 28.9) and R2 = 0.98835 (instead
...
ence when compared with Fig. 6 b and, therefore, was not pre-
sented herein. Similar results were obtained for the drying air
temperatures of 47.9 and 66.9 /C176C.
3.3.2. Latent heat of water vaporization
In a simulation with the drying air temperature at 58.6 /C176C, if the
...
v2 = 4146.1 (instead 28.9) and R2 = 0.75502 (instead 0.98843).
These results are completely unacceptable, and similar results
are obtained for the drying air temperatures of 47.9 and 66.9 /C176C.
On the other hand, at 58.6 /C176C, the use of the value of the latent heat
of vaporization of free water in the simulation resulted in statisti-
cal indicators given by v2 = 29.6 (instead 28.9) and R2 = 0.98832
...
T = 58.6 /C176C were used in a simulation, considering the transient
...
air temperatures of 47.9 and 66.9 /C176C, indicating that this simpliﬁca-
...
47.9 /C176C; (b) 58.6 /C176C; (c) 66.9 /C176C; (d) superposition of the simulated curves.
Fig. 7. Thermal diffusivity as a function of the average moisture content at drying
air temperature of: (a) 47.9 /C176C; (b) 58.6 /C176C; (c) 66.9 /C176C.
Fig. 8. Distribution of the temperatures at t = 10 min for the drying air temperature
of: (a) 47.9 /C176C; (b) 58.6 /C176C; (c) 66.9 /C176C.
...
can be obtained by an observation of Fig. 3 a–c for three tempera-
...
ture diffusivity are 2.79 /C2 10/C0 10 m2 s/C0 1 (47.9 /C176C and M = 0.121 db)
and 5.21 /C2 10/C0 9 m2 s/C0 1 (66.9 /C176C and M = 2.90 db). Details on
...
varied from 4.43 /C2 10/C0 7 to 4.98 /C2 10/C0 7 ms /C0 1. Similar results were
...
lines agree with experimental datasets. On the other hand, Fig. 6 d
...
initial instants of drying the thermal diffusivity (10 /C0 7 m2 s/C0 1)i s
greater than the moisture diffusivity (10 /C0 10 m2 s/C0 1)’’.
...
given by 0.835 /C2 10
/C0 7 (47.9 /C176C), 0.894 /C2 10/C0 7 (58.6 /C176C) and
1.67 /C2 10/C0 7 m2 s/C0 1 (66.9 /C176C). Based on the literature, these results
...
2.0 /C2 10/C0 9 m2 s/C0 1. The highest value obtained in the present paper
for the thermal diffusivity (1.67 /C2 10/C0 7 m2 s/C0 1) is lower that those
obtained by Mariani et al. (2008) , 1.88 /C2 10/C0 7, and Lima et al.
(2002), 2.70 /C2 10/C0 7 m2 s/C0 1. On the other hand, the value obtained
...
results were from 15 to 35 W m /C0 2 /C176C/C0 1. In the present work, this
property was determined by optimization and, at beginning of
the process, ranged between 15.2 (47.9 /C176C) and 28.3 W m /C0 2 /C176C/C0 1
(66.9 /C176C/C0 1). These results are compatible with those from Mariani
et al. (2008) , and also agree with those obtained by Lima et al.
(2002): from 12.7 to 19.0 W m /C0 2 /C176C/C0 1.
...
air temperature of 47.9 /C176C and t = 10 min the range of temperature
in the circular section was from 26.2 (center) to 28.9 /C176C (surface).
For the drying air temperatures of 58.6 and 66.9 /C176C, these ranges
were 28.4–34.0 and 37.3–46.4 /C176C, respectively. Finally, although
...
drying at 66.9 /C176C has lesser radius than other circles, once the
